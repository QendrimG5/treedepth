...
node_type_selection_probability = {'subtree': 10, 'internal': 10, 'leaf': 0, 'leafs': 10, 'root': 10,
...
try:
    ...
    excel_file = f"exectest_{timestamp}_leaf_final.xlsx"  # dynamic Excel file name
    df.to_excel(excel_file, index=False)
