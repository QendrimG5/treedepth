...
node_type_selection_probability = {'subtree': 10, 'internal': 10, 'leaf': 10, 'leafs': 0, 'root': 10,
...
try:
    ...
    excel_file = f"exectest_{timestamp}_leafs_final.xlsx"  # dynamic Excel file name
    df.to_excel(excel_file, index=False)
