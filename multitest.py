...
node_type_selection_probability = {'subtree': 10, 'internal': 10, 'leaf': 10, 'leafs': 10, 'root': 10,
                                   'top': 10, 'bottom': 10, 'level': 10, 'path': 10, 'partial_path': 0, 'partial_path_bottom': 10}
...
try:
    ...
    excel_file = f"exectest_{timestamp}_partial_path_final.xlsx"  # dynamic Excel file name
    df.to_excel(excel_file, index=False)
