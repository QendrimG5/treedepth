...
node_type_selection_probability = {'subtree': 10, 'internal': 10, 'leaf': 10, 'leafs': 10, 'root': 10,'top': 10, 'bottom': 10, 'level': 10, 'path': 0, 'partial_path': 10, 'partial_path_bottom': 10}
